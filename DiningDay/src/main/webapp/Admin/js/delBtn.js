				...
				if (result.isConfirmed) {
					...
					.then((result) => {
						if($(this).parent("div").parent("div").siblings(".container").children().children().children(".tr1").children("#sRep_no").text().substring(0,2) == "SR"){
							...
							var rRep_no = $(this).parent().parent().siblings(".row2").children("#article-table1").children().children(".tr1").children().siblings("td").text();
							location.href = "admin_userReportDelete.ad?RREP_NO="+rRep_no;
