        ...
        <nav class="nav">
            <div>
                ...
                <div class="nav__list">
                 ...
                 <div class="nav__list">  
                    <ul>
	                    ...
	                    <li><a class="nav__link" href="${ pageContext.request.contextPath }/Store/sreview.jsp" style="width: 130px;">
                ...
                <ul>
                    ...
                    <li class="mt-2"><a class="nav__link" href="${ pageContext.request.contextPath }/Store/logout.jsp" style="width: 130px;">
                    	<small>● 로그아웃</small></a>
                    </li>
            	</ul>
            </div>
