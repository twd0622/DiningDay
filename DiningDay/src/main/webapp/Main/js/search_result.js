var storeTag = function(data){
	for(storeInfo of data){
		var searchResultStore = 
	        ...
	        +           '<div class="portfolio-caption-subheading text-muted" style="display: flex;"><span class="material-icons" style="color: #F7CE3E;">grade</span>'+storeInfo.STORE_SCORE+'점('+storeInfo.STORE_REVIEW_COUNT+'명)</div>'
