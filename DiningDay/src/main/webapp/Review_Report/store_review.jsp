...
<!--  [{
        CUS_NICK=최승민
      , REV_CONTENT=llllllllllllllllllllllllllllllllllllllllllllllllyyyyyyyyyyyyyyyyyyyyyyy
      , ANSWER_DATE=(수정) 2024-01-17 17:16:00
      , REV_DATE=2024-01-15 19:57:34.0
      , REV_SCORE=5
      , REV_IMAGE=horses-5716127_640.jpg
      , SEAT_NAME=A1
      , MENU_NAME=기본 예약금/1
      , ANSWER_CONTENT=리뷰 감사합니다! 다음에도 방문해 주세요~~
      , REV_NO=RV1} -->
				<!-- 리뷰 시작 -->
