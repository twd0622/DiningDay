...
<head>
    ...
    <link href="${ pageContext.request.contextPath }/muchang/resour/css/sResButton.css" rel="stylesheet" />
    ...
    <style>
    	...
    	<script src="${ pageContext.request.contextPath }/muchang/resour/js/sRes_control.js"></script>
