...
<head>
	...
	<%@ include file="/Template/store_sidebar_open.jsp"%> 	
    	...
    	<script src="${ pageContext.request.contextPath }/muchang/resour/js/menu_control.js"></script>
    	<script src="${ pageContext.request.contextPath }/muchang/resour/js/photo_control.js"></script>
