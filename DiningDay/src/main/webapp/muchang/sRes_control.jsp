...
<head>
    ...
    <link href="${ pageContext.request.contextPath }/muchang/resour/css/sResmodal.css" rel="stylesheet" />
	<style type="text/css">
		td, th {
			...
			<div class="mainContainer row" style="border: 1px solid black; width: 100%; height: 1500px; background:white; ">
				...
				<div class="col" style="border-left:none; display: flex; justify-content:center; align-items : center;">	
					<table border="1" style="width:700px;">
						...
						<tbody>	
							<tr>
								<td><a href="${ pageContext.request.contextPath }/muchang/sRes.jsp">1일</a></td>
								<td>월요일</td>
								<td>12</td>
							</tr>
							<tr>
								<td><a href="${ pageContext.request.contextPath }/muchang/sRes.jsp">3일</a></td>
								<td>수요일</td>
								<td>10</td>
							</tr>
							<tr>
								<td><a href="${ pageContext.request.contextPath }/muchang/sRes.jsp">15일</a></td>
								<td>금요일</td>
								<td>18</td>
							</tr>
							<tr>
								<td><a href="${ pageContext.request.contextPath }/muchang/sRes.jsp">17일</a></td>
								<td>일요일</td>
								<td>10</td>
							</tr>
						</tbody>	
...
<script type="text/javascript" src="${ pageContext.request.contextPath }/muchang/resour/js/chart_control.js">
</script> 
