	...
	<%@ include file="/Template/store_sidebar_open.jsp"%> 	
		<main style="display: flex;  align-items: center; text-align: center; padding:100px;">
			...
			display: flex; flex-direction: column; justify-content: center; align-items: center;">
				...
				<div class="mt-2 mb-3" id="checkboxList">
					<input class="0 rounded-4 shadow" type="checkbox" style="pointer-events: none;">&nbsp;&nbsp;
			 		<input class="1 rounded-4 shadow" type="checkbox" style="pointer-events: none;">&nbsp;&nbsp;
					<input class="2 rounded-4 shadow" type="checkbox" style="pointer-events: none;">&nbsp;&nbsp;
					<input class="3 rounded-4 shadow" type="checkbox" style="pointer-events: none;">&nbsp;&nbsp;
					<input class="4 rounded-4 shadow" type="checkbox" style="display:none;" checked>
					<input class="5 rounded-4 shadow" type="checkbox" style="pointer-events: none;">&nbsp;&nbsp;
					<input class="6 rounded-4 shadow" type="checkbox" style="pointer-events: none;">&nbsp;&nbsp;
					<input class="7 rounded-4 shadow" type="checkbox" style="pointer-events: none;">&nbsp;&nbsp;
				</div>
				<div style="display: flex;">
					<div class="storePaging">
					<div name="storeBold" class="rounded-4 shadow" style="width: 700px; padding:30px; background-color: white; display: flex; border-radius: 25px; flex-direction: column; align-items: center;">
						<div><h3>가게 설정</h3></div>
						...
						<div class="mt-3" style="width:500px; display: flex; justify-content: center">
							...
							<div style="width: 350px; text-align: left;">	
								<div class="input-group mb-3">
								  	<textarea id="member_addr" type="text" class="form-control" placeholder="지번 주소" aria-label="지번 주소" 
					...
					<div>
						<div class="storePaging">					
						<div name="storeBold" class="rounded-4 shadow" style="width: 700px; padding:30px; background-color: white; display: flex; align-items: center; flex-direction: column; border-radius: 25px;">
							<h3>휴무일이 있나요?</h3>
							<div>
						...
						<div name="storeBold" class="mt-5 rounded-4 shadow" style="width: 700px; padding:30px; background-color: white; display: flex; justify-content: center; flex-direction: column; border-radius: 25px;">
							<div>
						...
						<div name="storeBold" id="restTime" class="mt-5 rounded-4 shadow" style="width: 700px; padding:30px; background-color: white; display: flex; justify-content: center; flex-direction: column; border-radius: 25px;">		 
							<div style="display: flex; justify-content: space-around">
						...
						<div name="storeBold" id="resIstrueTimeCheck" class="mt-5 rounded-4 shadow" style="width: 700px; padding:30px; background-color: white; display: flex; justify-content: center; flex-direction: column; border-radius: 25px;">
							<div>
								<div style="display: flex; justify-content: space-around">
				...
				<div style="display: flex; justify-content: center;" class="mb-2">
					<div style="width: 700px; padding:30px; background-color: white; display: flex; align-items: center; flex-direction: column;
					 border-radius: 25px; border: ipx solid salmon !impotant;" class="rounded-4 shadow">
						<h3>사진 등록 해주세요 :)</h3>
					</div>
				</div>
				<div style="display: flex; flex-direction: column; align-items: center" class="mt-3">			
					<div style="display: flex;">
						<div name="storeBold" class="rounded-4 shadow" style="background-color: white; width: 500px; border-radius: 25px; display: flex;flex-direction: column">
						...
						<div name="storeBold" class="rounded-4 shadow" style="background-color: white; width: 900px; border-radius: 25px; display: flex;flex-direction: column; border: 1px ">
				...
				<div class="mt-5" id="validCheckBtn">
					<button type="button" class="btn btn-danger rounded-4 shadow" style="width: 125px; height:40px;">이전</button>
					<button type="button" class="btn btn-success rounded-4 shadow" style="width: 125px; height:40px; ">다음</button>
				</div>  
				<div class="mt-3">
					<button type="button" class="btn btn-success btn-lg rounded-4 shadow" id="totalInsert">등록하기</button>
			    </div>
			</div>
    	</main>
