	...
	<div class="modal-dialog" role="document">
		<div class="modal-content rounded-4 shadow">
			...
			<div class="modal-body p-5 pt-0">
				<form action="search_pwPro.ow" style="text-align: center;" method="post" name="searchPw">
				...
				<div id="authModal" class="modal">
				  <div class="modal-content" id="auth-modal-content">
				     ...
				     <div class="modal-footer" id="auth-modal-footer">
				       <button type="button" class="btn btn-outline-warning" id="authOk">변경</button>   
...
authBtn.onclick = function() {
	if(!inputs.pwCode.value) {        // 입력하지 않았을 때
		alert("인증번호를 입력하세요.");
		authmodal.style.display = "none";
	} else if(AuthNumber != inputs.pwCode.value){   // 값이 틀렸을 때 
